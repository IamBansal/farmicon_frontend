...
class SoilTestingSubpage extends StatelessWidget {
  SoilTestingSubpage({required HomeViewModel model, Key? key})
      : super(key: key) {
    model.fetchSoilTestingCenters();
  }
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          AText(
                            AppLocalization.of(context).getTranslatedValue('soilTestingInfoHeader').toString(),
                            style: AppTheme.vendorDataTitleStyle,
                          ),
                          AText(
                            model.textsMap['testingInfoCollapsed']![
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 8.r),
                    AText(
                      '${model.textsMap['testingInfoExpanded']![AppLocalization.of(context).locale]}\n',
                      style: AppTheme.otpInstructionsStyle.copyWith(
                        fontWeight: FontWeight.w500,
                        height: 18 / 12,
                        color: AppTheme.text,
      ...
      children: <Widget>[
        ...
        Align(
          ...
          child: Padding(
            ...
            child: AText(
              AppLocalization.of(context).getTranslatedValue('soilTestingSectionHeader').toString(),
        ...
        Padding(
          ...
          child: Material(
            ...
            child: Padding(
              ...
              child: (model.soilTestingCenters.isNotEmpty)
                  ? Column(
                      mainAxisSize: MainAxisSize.min,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: List<Widget>.generate(
                        model.soilTestingCenters.length,
                        (index) =>
                            VendorInfoCard(model.soilTestingCenters[index]),
                      ),
                    )
                  : const Center(
