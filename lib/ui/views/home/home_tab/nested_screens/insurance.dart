...
class InsuranceSubpage extends StatelessWidget {
  InsuranceSubpage({required HomeViewModel model, Key? key}) : super(key: key) {
    model.fetchInsuranceCenters();
  }
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          AText(
                            AppLocalization.of(context).getTranslatedValue('insuranceInfoHeader').toString(),
                            style: AppTheme.vendorDataTitleStyle,
                          ),
                          AText(
                            model.textsMap['insuranceInfoCollapsed']![
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 8.r),
                    AText(
                      '${model.textsMap['insuranceInfoExpanded']![AppLocalization.of(context).locale]}\n',
                      style: AppTheme.otpInstructionsStyle.copyWith(
                        fontWeight: FontWeight.w500,
                        height: 18 / 12,
                        color: AppTheme.text,
      ...
      children: <Widget>[
        ...
        Align(
          ...
          child: Padding(
            ...
            child: AText(
              AppLocalization.of(context).getTranslatedValue('insuranceSectionHeader').toString(),
        ...
        Padding(
          ...
          child: Material(
            ...
            child: Padding(
              ...
              child: (model.insuranceCenters.isNotEmpty)
                  ? Column(
                      mainAxisSize: MainAxisSize.min,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: List<Widget>.generate(
                        model.insuranceCenters.length,
                        (index) =>
                            VendorInfoCard(model.insuranceCenters[index]),
                      ),
                    )
                  : const Center(
